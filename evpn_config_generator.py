...
output_yaml_file_path = "evpn_vars.yml"
...
with open(output_yaml_file_path, 'w') as yaml_file:
...
#            print(item)
            ...
            yaml_file.write("\n")
print(f"YAML file generated at: {output_yaml_file_path}")




# Define the source file path
source_file = 'evpn_vars.yml'
